...
const parser = new ArgumentParser({ description: 'Configuration options for our crawler & support files.' })
...
parser.add_argument('--task', { help: 'Next subject id for the crawler.' })
...
// Allow for optional command in string form ex: npx crawler --args ... "command1 --args1"
parser.add_argument('command', { help: "Command to pass into the CLI tool. ex: npx crawler --args ... \"command1 --args1\"", nargs: '?'})
